...
export default function MedicationAvailabilitySearch() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      setLoading(true);
      await fetch(
        "https://rxflow-backend-1-ky18.onrender.com/api/mail/medication-availability",
        {
          method: "POST",
          ...
          <div className="space-y-6 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  t: "Quick Search",
                  d: "Search thousands of medications in seconds.",
                },
                {
                  t: "Easy Confirmation",
                  d: "We’ll confirm availability for you.",
                },
                {
                  t: "Fast Response",
                  d: "Our pharmacy team responds promptly.",
                },
              ].map((c) => (
                <div
                  key={c.t}
          ...
          <div className="mt-12 bg-white border-2 border-blue-200 rounded-3xl p-8 shadow-xl space-y-6">
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-base text-slate-700 leading-relaxed">
                This medication is typically stocked or sourced by BergenRoad
                Pharmacy. Availability can change in real time.
              </p>
            </div>
    ...
    "
                ...
                <label className="flex gap-3 text-sm text-slate-700 p-4 bg-blue-50 rounded-lg">
                  ...
                  <span className="leading-relaxed">
                    I authorize United Drugs to contact me regarding this
                    request.{" "}
                    <button
                      type="button"
                      ...
                      <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center px-4">
                        <div className="bg-white max-w-lg w-full rounded-2xl p-6 shadow-2xl relative">
                          ...
                          <div className="space-y-3 text-sm text-slate-700 leading-relaxed max-h-[60vh] overflow-y-auto">
                            ...
                            <p>
                              You authorize United Drugs to contact you via
                              phone, text message, or email regarding your
                              prescription inquiry, medication availability,
                              insurance verification, or savings options.
                            </p>

                            <p>
                              Information submitted through this form is used
                              solely for pharmacy communication and will not be
                              sold or shared with third parties except as
                              required for prescription processing or insurance
                              verification.
                            </p>

                            <p>
                              By continuing, you acknowledge that electronic
                              submission constitutes your consent in accordance
